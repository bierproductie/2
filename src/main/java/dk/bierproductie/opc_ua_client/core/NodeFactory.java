...
public class NodeFactory {
    ...
    private Map<String, NodeId> adminNodeMap;
    private Map<String, NodeId> statusNodeMap;
    private Map<String, NodeId> commandNodeMap;

    public Map<String, NodeId> getAdminNodeMap() {
        return adminNodeMap;
    }

    public Map<String, NodeId> getStatusNodeMap() {
        return statusNodeMap;
    }

    public Map<String, NodeId> getCommandNodeMap() {
        return commandNodeMap;
    }
